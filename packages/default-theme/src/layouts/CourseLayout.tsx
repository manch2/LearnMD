...
export function CourseLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-[rgb(var(--bg-primary))] text-[rgb(var(--text-primary))] transition-colors duration-200">
      <Header 
        title={courseTitle}
        actions={
          <div className="flex items-center gap-4">
            {sidebarCollapsible && (
              <button
                ...
                className="xl:hidden p-2 -ml-2 rounded-md hover:bg-[rgb(var(--bg-secondary))] mr-2"
              >
