...
export const COMMON_TRANSLATIONS = {
  en: {
    ...
    'course.no_lessons': 'No lessons available yet.',
    ...
    'catalog.filter_all_categories': 'All Categories',
    'catalog.filter_all_difficulties': 'All Difficulties',
    'catalog.filter_all_durations': 'All Durations',
    'catalog.hero_subtitle': 'Ready to learn? Choose from our interactive courses below and start your journey.',
    ...
    'profile.score': 'Global Score',
    'profile.score_public': 'Public learner score',
    ...
    'course.next': 'Next',
    'course.mark_complete': 'Mark Complete & Next',
    'course.finish': 'Finish Course',
    'course.return_overview': 'Return to Overview',
    'course.not_found': 'Lesson not found.',
    'profile.complete_to_download': 'Complete the course to download',
    'gamification.earned_on': 'Earned on',
    'gamification.current_streak': 'Current Streak',
    'gamification.best_streak': 'Best Streak',
    'gamification.total_points': 'Total Points',
    'gamification.badges_earned': 'Badges Earned',
  ...
  es: {
    ...
    'course.review': 'Repasar Curso',
    'course.completed': 'Completado',
    'course.difficulty': 'Dificultad',
    'course.duration': 'Tiempo',
    'course.syllabus': 'Syllabus',
    'course.prerequisites': 'Requisitos Previos',
    'course.what_learn': 'Habilidades a Desarrollar',
    'course.no_lessons': 'Aún no hay lecciones disponibles.',
    ...
    'catalog.filter_all_categories': 'Todas las Categorías',
    'catalog.filter_all_difficulties': 'Todas las Dificultades',
    'catalog.filter_all_durations': 'Todas las Duraciones',
    'catalog.hero_subtitle': '¿Listo para aprender? Elige entre nuestros cursos interactivos y comienza tu viaje.',
    ...
    'profile.score': 'Puntaje Global',
    'profile.score_public': 'Puntaje público del estudiante',
    'profile.in_progress': 'En Progreso',
    ...
    'quiz.keep_trying': '¡Sigue intentándolo!',
    'quiz.review_answers': 'Revisar Respuestas',
    ...
    'course.updated': 'Actualizado',
    'course.previous': 'Anterior',
    'course.next': 'Siguiente',
    'course.mark_complete': 'Marcar como completado y siguiente',
    'course.finish': 'Finalizar curso',
    'course.return_overview': 'Volver a la vista general',
    'course.not_found': 'Lección no encontrada.',
    'profile.complete_to_download': 'Completa el curso para descargar',
    'gamification.earned_on': 'Obtenido el',
    'gamification.current_streak': 'Racha actual',
    'gamification.best_streak': 'Mejor racha',
    'gamification.total_points': 'Puntos totales',
    'gamification.badges_earned': 'Insignias obtenidas',
    'nav.profile': 'Perfil de usuario',
    'theme.switch_to': 'Cambiar a modo',
  },
};
